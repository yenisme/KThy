var YenNo2 = JSON.parse($response.body);
...
if ($request.url.indexOf(vipa) != -1) {
    YenNo2.data["psnl_vip_property"] = vip;
    YenNo2.data["fax_balance"] = "99999";
    YenNo2.data["used_points"] = "99999";
    YenNo2.data["points"] = "99999";
    YenNo2.data["pdfword_balance"] = "100010";
    YenNo2.data["bookmode_balance"] = 100010;
    YenNo2.data["immt_expy_points"] = "99999";
    YenNo2.data["ocr_balance"] = 99999;
    YenNo2.data["no_login_ocr_balance"] = "99999";
    YenNo2.data["CamScanner_RoadMap"] = 100000;
}

if ($request.url.indexOf(vipb) != -1) {
    YenNo2.data.ar_property["psnl_vip_property"] = vip;
}
...
$done({ body: JSON.stringify(YenNo2) });
